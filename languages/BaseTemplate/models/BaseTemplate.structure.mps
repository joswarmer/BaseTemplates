...
<model ref="r:7c0e94c7-78c3-4e1c-b938-14b308eab0c5(BaseTemplate.structure)">
  ...
  <node concept="1TIwiD" id="2LAMgc0tLpx">
    ...
    <node concept="1TJgyj" id="fzclF7Z" role="1TKVEi">
      ...
      <ref role="20ksaX" to="tpee:fzclF7Z" resolve="body" />
      <ref role="20lvS9" node="2LAMgc0tT_0" resolve="MethodBodyStatementList3" />
    </node>
  </node>
  <node concept="1TIwiD" id="2LAMgc0tLUa">
    <property role="EcuMT" value="3199465600023207562" />
    <property role="3GE5qa" value="methods" />
    <property role="TrG5h" value="TemplateMethodBody3" />
    <ref role="1TJDcQ" to="tpck:gw2VY9q" resolve="BaseConcept" />
  </node>
  <node concept="1TIwiD" id="2LAMgc0tT_0">
    <property role="EcuMT" value="3199465600023238976" />
    <property role="3GE5qa" value="methods" />
    <property role="TrG5h" value="MethodBodyStatementList3" />
    <ref role="1TJDcQ" to="tpee:fzclF80" resolve="StatementList" />
  </node>
  <node concept="1TIwiD" id="2LAMgc0tTOm">
    <property role="TrG5h" value="StubMethodBodyStatementList3" />
    <property role="3GE5qa" value="methods" />
    <property role="EcuMT" value="3199465600023239958" />
    <ref role="1TJDcQ" node="2LAMgc0tT_0" resolve="MethodBodyStatementList3" />
    <node concept="PrWs8" id="2LAMgc0tTOo" role="PzmwI">
